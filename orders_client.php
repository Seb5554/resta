  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="logout.php" class="btn btn-secondary"   >
        <span class="text text-1">Déconnection</span>

        <span class="text text-2" aria-hidden="true">Déconnection</span>
      </a>
...
<tr>
<th class="healine-1"><B><span STYLE="padding:0 0 0 45px;">Numéro de la réservation</span></B></font></th>
<th class="healine-1"><B><span STYLE="padding:0 0 0 45px;">Nom</span></B></font></th>
<th class="healine-1"><B><span STYLE="padding:0 0 0 45px;">Télephone</span></font></B></th>
<th class="healine-1"><B><span STYLE="padding:0 0 0 45px;">Date de la reservation </span></font></B></th>
<th class="healine-1"><B><span STYLE="padding:0 0 0 45px;">Nombre de personnes</span></font></B></th>
</tr>

<?php

$id= $bdd->query("select * from reservation where id_client='$check' order by dateC desc "); 
				 foreach($id as $valeur) {
				 ?>
				 			<tr>
							<td><span STYLE="padding:0 0 0 45px;"><?php echo 'Res'.$valeur['id_com']; ?></span></td>
							<td><span STYLE="padding:0 0 0 45px;"><?php echo $valeur['name']; ?></span></td>
							<td><span STYLE="padding:0 0 0 45px;"><?php echo $valeur['phone']; ?></span></td>
							<td><span STYLE="padding:0 0 0 45px;"><?php echo $valeur['dateC'].'  '.$valeur['timeC']; ?></span></td>
							<td><span STYLE="padding:0 0 0 45px;"><?php echo $valeur['persons']; ?></span></td>
